...
double xCoord = double(45);
double yCoord = double(45);
double r = double(15);
...
*/
{
    ...
    //return 100.0*pow(y - x*x,2) + pow(1 - x,2);
		...
		return -1.0*getFunct.ObjFunction3D(x,y,z,mu);
...
!*/
{
    ...
    column_vector res(3);
		...
		gradVal = getFunct.ObjFunction3DGrad(x,y,z,mu);
...
matrix<double> rosen_hessian (const column_vector& m)
{
    ...
    //res(1,1) = 200;                 // second derivative with respect to y
		...
		//matrix<double> hessVal(3,3);

		//hessVal = getFunct.ObjFunction3DHessian(x,y,z,mu);

		res = -1.0*getFunct.ObjFunction3DHessian(x,y,z,mu);
...
int main()
{
    ...
    try
    {
        ...
        column_vector starting_point(3);
				...
				// set limits of box
				column_vector boxMin(3), boxMax(3);
        ...
        //starting_point = 28, 28;
				...
				starting_point = xCoord, yCoord, r;
        ...
        //                         rosen, rosen_derivative, starting_point, 0.1, 0.8);
				...
				starting_point = xCoord, yCoord, r; // Start with a valid point inside the constraint box.
				find_min_box_constrained(lbfgs_search_strategy(10),
																 objective_delta_stop_strategy(1e-9),  
