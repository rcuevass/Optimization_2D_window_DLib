...
Point5D::Point5D(double x, double y, double z, double w, double u) { 
	m_data[0] = x;
	m_data[1] = y;
	m_data[2] = z;
	m_data[3] = w;
...
Point5D::Point5D(const Point5D& other) {
	m_data[0] = other.m_data[0];
	m_data[1] = other.m_data[1];
	m_data[2] = other.m_data[2];
	m_data[3] = other.m_data[3];
...
Point5D::Point5D(const Point4D& other) {
	m_data[0] = other[0];
	m_data[1] = other[1];
	m_data[2] = other[2];
	m_data[3] = other[3];
...
Point5D::Point5D(const Point4D& other, double u) {
	m_data[0] = other[0];
	m_data[1] = other[1];
	m_data[2] = other[2];
	m_data[3] = other[3];
...
Point5D& Point5D::operator =(const Point5D& other) {
	m_data[0] = other.m_data[0];
	m_data[1] = other.m_data[1];
	m_data[2] = other.m_data[2];
	m_data[3] = other.m_data[3];
...
double& Point5D::operator[](int i) {
	return m_data[i];
}

double Point5D::operator[](int i) const {
	return m_data[i];
}

double Point5D::dot(const Point5D& other) const
{
	return m_data[0]*other.m_data[0] + 
		m_data[1]*other.m_data[1] + 
		m_data[2]*other.m_data[2] +
...
double Point5D::SqrDistanceTo(const Point5D& other) const{
	return (m_data[0]-other.m_data[0])*(m_data[0]-other.m_data[0])+
		(m_data[1]-other.m_data[1])*(m_data[1]-other.m_data[1])+
		(m_data[2]-other.m_data[2])*(m_data[2]-other.m_data[2])+
		(m_data[3]-other.m_data[3])*(m_data[3]-other.m_data[3])+
		(m_data[4]-other.m_data[4])*(m_data[4]-other.m_data[4]);
}


double Point5D::length() const
{
	return sqrt(dot(*this));
}
